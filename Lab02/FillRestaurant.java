...
public class FillRestaurant{
  public static void main(String[]args){
    ...
    final String DATE = "30th July 2016";  // dining date
    ...
    int vacancy = MAX_OCCUPANCY - (vanDiners + busDiners); // seats left in restaurant 
    System.out.println("Seats left for " + DATE + " : " + vacancy);
  }
}
